...
class Config:
    ...
    data_dir: str = "/run/media/junzhe/SLAM_DATA/data/museum/colmap/kitchen/"
    # Name of the dataset (rgbd, tum, tartanair)
    dataset: str = "rgbd"
    # Downsample factor for the dataset
    data_factor: int = 4
    # Directory to save results
    result_dir: str = "/run/media/junzhe/SLAM_DATA/data/gsplat/"
...
class Runner:
    ...
    def render_traj(self, step: int):
        ...
        camtoworlds = self.parser.camtoworlds[10:11, :3]
        ...
        canvas_all = []
        print(f'len(camtoworlds): {len(camtoworlds)}')
        for i in tqdm.trange(len(camtoworlds), desc="Rendering trajectory"):
            print('render_traj() call self.rasterize_splats')
